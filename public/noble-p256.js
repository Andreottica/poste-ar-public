var nobleCurves = (() => {
  ...
  function createOPRF(opts) {
    ...
    function generateProof(ctx, k, B, C, D, rng) {
      ...
      return concatBytes2(...[c, s].map((i) => Fn.toBytes(i)));
    }
    function verifyProof(ctx, B, C, D, proof) {
      abytes2(proof, 2 * Fn.BYTES);
  ...
  var p256_FROST = /* @__PURE__ */ (() => createFROST({
  ...
  var p521 = /* @__PURE__ */ ecdsa(p521_Point, sha512);
  ...
  return __toCommonJS(nist_exports);
})();
